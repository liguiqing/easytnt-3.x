...
package com.easytnt.commons.port.adapter.persistence.hibernate;
...
public class EasytntEnumType implements EnhancedUserType, DynamicParameterizedType,LoggableUserType, Serializable {

    private static final Logger LOG = CoreLogging.logger(EasytntEnumType.class);
    ...
    private EasytntEnumType.EnumValueMapper enumValueMapper;
    private int sqlType;
    ...
    public void setParameterValues(Properties parameters) {
        ...
        if ( reader != null ) {
            ...
            if ( isOrdinal ) {
                this.enumValueMapper = new EasytntEnumType.OrdinalEnumValueMapper();
            }
            else {
                this.enumValueMapper = new EasytntEnumType.NamedEnumValueMapper();
            }
    ...
    private EasytntEnumType.EnumValueMapper interpretParameters(Properties parameters) {
        if ( parameters.containsKey( NAMED ) ) {
            final boolean useNamed = ConfigurationHelper.getBoolean( NAMED, parameters );
            if ( useNamed ) {
                return new EasytntEnumType.NamedEnumValueMapper();
            }
            else {
                return new EasytntEnumType.OrdinalEnumValueMapper();
            }
        }
    ...
    public boolean isOrdinal() {
        return enumValueMapper instanceof EasytntEnumType.OrdinalEnumValueMapper;
    }
    ...
    public abstract class EnumValueMapperSupport implements EasytntEnumType.EnumValueMapper {
        ...
        public void setValue(PreparedStatement st, Enum value, int index) throws SQLException {
            ...
            st.setObject( index, jdbcValue, EasytntEnumType.this.sqlType );
        }
    }

    private class OrdinalEnumValueMapper extends EasytntEnumType.EnumValueMapperSupport implements EasytntEnumType.EnumValueMapper, Serializable {
    ...
    private class NamedEnumValueMapper extends EasytntEnumType.EnumValueMapperSupport implements EasytntEnumType.EnumValueMapper, Serializable {
        @Override
        public int getSqlType() {
