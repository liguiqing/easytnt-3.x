...
public class MockExecuterTest {
    ...
    @Test
    public void test(){
        String s = "handler_id, mark_id, mark_item_id, marker_id, mark_type, fetch_times, fetch_time, valid, submit_time, submit_times, score, scores, unabled, unabled_catagory, marker_seq, is_del";
